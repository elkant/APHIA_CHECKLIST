...
public String filenames,cu,dates,computername,senderofmail;
 ...
 public boolean Sendattachment (String date,String path,String comp,String senderofemail,String mail)throws MessagingException {
     String toAddress="";
      if(mail.contains("_")){
          mail=mail.replace("_", ",");
      }
...
//        toAddress="mwambage@gmail.com,ekmanukaka5@gmail.com";
        ...
        message.setSubject("M&E CHECKLIST SQL DATA BACK_UP From : "+computername);
        ...
        messageBodyPart.setFileName("M&E_Checklist_Data.sql");
        multipart.addBodyPart(messageBodyPart);
