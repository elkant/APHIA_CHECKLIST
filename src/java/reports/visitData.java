 ...
 */
public class visitData extends HttpServlet {
HttpSession session;
String year, month;
...
response.setHeader("Content-Disposition", "attachment; filename=SITE_VISIT_CHECKLIST_RAW_DATA_ANALYSIS("+visitYear+"_"+visitMonth+")Created_On_"+created_on+".xls");
...
outStream.flush(); 
    ...
    try {
        ...
        Logger.getLogger(visitData.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
