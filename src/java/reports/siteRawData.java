 ...
 */
public class siteRawData extends HttpServlet {
HttpSession session;
String year, month;
...
int x=0;
      ...
      String getDataElement="SELECT indicator,id FROM indicators";
...
//    x+=4;
  ...
  rw1cell9.setCellStyle(style);
     ...
     String  getAllFacil="SELECT DISTINCT hf_id FROM htc_site WHERE year='"+year+"' && month='"+month+"'";
...
//       GET ALL DATA FOR THIS MONTH............................
       ...
       String getHTC="SELECT recounted_data,reported_711A,reported_731,reported_DHIS,indicator_id FROM htc_site WHERE hf_id='"+facility_id+"' && year='"+year+"' && month='"+month+"'";
         ...
         htc_Data1=conn.rs.getString(1).trim();
          htc_711A1=conn.rs.getString(2).trim();
          htc_7311=conn.rs.getString(3).trim();
          htc_DHIS1=conn.rs.getString(4).trim();
          
          if(!htc_7311.equals("")){
              System.out.println("recounted : "+htc_Data1+"   reported 731 : "+htc_7311);
           if(Integer.parseInt(htc_7311)==Integer.parseInt(htc_Data1)){
          ...
          else if(!htc_711A1.equals("")){
          if(Integer.parseInt(htc_711A1)==Integer.parseInt(htc_Data1)){
            isEqual=1;    
           }
           else{
           isEqual=0;     
...
//      System.out.println(" id  htc :  "+conn.rs.getString(5));          
     ...
     if(!htc_Data1.equals("")){rw1cell10.setCellValue(Integer.parseInt(htc_Data1));if(isEqual==0){rw1cell10.setCellStyle(styleRED);}else{rw1cell10.setCellStyle(style_green);}}
     ...
     if(!htc_DHIS1.equals("")){rw1cell13.setCellValue(Integer.parseInt(htc_DHIS1));rw1cell13.setCellStyle(style_green);}
       ...
       String getPMTC="SELECT recounted_data,reported_711A,reported_731,reported_DHIS,indicator_id FROM pmtct_site WHERE hf_id='"+facility_id+"' && year='"+year+"' && month='"+month+"'";
        conn.rs=conn.st.executeQuery(getPMTC);
         ...
         pmtct_Data1=conn.rs.getString(1).trim();
         pmtct_711A1=conn.rs.getString(2).trim();
         pmtct_7311=conn.rs.getString(3).trim();
         pmtct_DHIS1=conn.rs.getString(4).trim();
         
         if(!pmtct_7311.equals("")){
              System.out.println("recounted : "+pmtct_Data1+"   reported 731 : "+pmtct_7311);
           if(Integer.parseInt(pmtct_7311)==Integer.parseInt(pmtct_Data1)){
                System.out.println("are equal");
            isEqual=1;    
           }
           else{
          ...
          else if(!pmtct_711A1.equals("")){
          if(Integer.parseInt(pmtct_711A1)==Integer.parseInt(pmtct_Data1)){
            isEqual=1;    
           }
           else{
           isEqual=0;     
     ...
     if(!pmtct_Data1.equals("")){rw1cell10.setCellValue(Integer.parseInt(pmtct_Data1));if(isEqual==0){rw1cell10.setCellStyle(styleRED);}else{rw1cell10.setCellStyle(style_green);}}
     ...
     if(!pmtct_DHIS1.equals("")){rw1cell13.setCellValue(Integer.parseInt(pmtct_DHIS1));rw1cell13.setCellStyle(style_green);}
       ...
       conn.rs=conn.st.executeQuery(getCARE);
         ...
         care_Data=care_711A=care_731=care_DHIS=0;
           ...
           care_Data1=conn.rs.getString(1);
          care_711A1=conn.rs.getString(2);
         care_7311=conn.rs.getString(3);
         care_DHIS1=conn.rs.getString(4);
         
         if(!care_7311.equals("")){
              System.out.println("recounted : "+care_Data1+"   reported 731 : "+care_7311);
           if(Integer.parseInt(care_7311)==Integer.parseInt(care_Data1)){
                System.out.println("are equal");
            isEqual=1;    
           }
           else{
          ...
          else if(!care_711A1.equals("")){
          if(Integer.parseInt(care_711A1)==Integer.parseInt(care_Data1)){
            isEqual=1;    
           }
           else{
           isEqual=0;     
     ...
     if(!care_Data1.equals("")){rw1cell10.setCellValue(Integer.parseInt(care_Data1));if(isEqual==0){rw1cell10.setCellStyle(styleRED);}else{rw1cell10.setCellStyle(style_green);}}
       ...
       String getTB ="SELECT recounted_data,reported_711A,reported_731,reported_DHIS,indicator_id FROM tb_site WHERE hf_id='"+facility_id+"' && year='"+year+"' && month='"+month+"'";
         ...
         while(conn.rs.next()){
           ...
           tb_Data=tb_711A=tb_731=tb_DHIS=0; 
            ...
            tb_Data1=conn.rs.getString(1);
           tb_711A1=conn.rs.getString(2);
           tb_7311=conn.rs.getString(3);
           tb_DHIS1=conn.rs.getString(4);
           
           if(!htc_7311.equals("")){
              System.out.println("recounted : "+tb_Data1+"   reported 731 : "+tb_7311);
           if(Integer.parseInt(tb_7311)==Integer.parseInt(tb_Data1)){
                System.out.println("are equal");
            isEqual=1;    
           }
           else{
          ...
          else if(!tb_711A1.equals("")){
          if(Integer.parseInt(tb_711A1)==Integer.parseInt(tb_Data1)){
            isEqual=1;    
           }
           else{
           isEqual=0;     
     ...
     if(!tb_Data1.equals("")){rw1cell10.setCellValue(Integer.parseInt(tb_Data1));if(isEqual==0){rw1cell10.setCellStyle(styleRED);}else{rw1cell10.setCellStyle(style_green);}}
...
response.setHeader("Content-Disposition", "attachment; filename=SITE_CHECKLIST_RAW_DATA.xls");
...
outStream.flush(); 
    ...
    try {
        ...
        Logger.getLogger(siteRawData.class.getName()).log(Level.SEVERE, null, ex);
    }
    }
