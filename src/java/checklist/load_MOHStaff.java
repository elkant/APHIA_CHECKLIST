 ...
 */
public class load_MOHStaff extends HttpServlet {
String mohstaff,fname,mname,lname,fullname;
String county="";
...
//              mohstaff="<option value=\"\">Choose MOH Staff</option>";
            mohstaff="";
...
if(conn.st!=null){
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet load_APHIAStaff at " +mohstaff+ "</h1>");
            out.println("</body>");
            out.println("</html>");
        } finally {            
            out.close();
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(load_MOHStaff.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
